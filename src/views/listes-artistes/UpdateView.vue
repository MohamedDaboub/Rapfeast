                ...
                <div class="rounded-xl flex gap-2">
                    ...
                    <div class="m-auto">
                        ...
                        <div class="flex justify-between gap-10 my-4">
                            <button type="submit" class="bg-Default/me/Gris px-8 py-4 my-7 text-base hover:bg-white hover:text-black text-white" @click.prevent="updateArtiste(Artiste)"> modifier
                            </button>
                            <RouterLink to="/liste" class=" bg-Default/me/Gris px-8 py-4 my-7 text-base hover:bg-white hover:text-black text-white" >
